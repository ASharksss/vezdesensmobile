          ...
          <div className='card'>
            <NavLink to='/cardPage' className='noLink'>
              ...
              <div className="card_img">
                <img src={`${STATIC_HOST}/${data?.previewImageAds[0]?.name}`} alt="" className='card_img-image'/>
              </div>
            ...
            <div className='plus_card'>
              <NavLink to='/cardPage' className='noLink'>
                ...
                <div className="plus_card_img">
                  <img src={`${STATIC_HOST}/${data?.previewImageAds[0]?.name}`} alt="" className='plus_card_img-image'/>
                </div>
              ...
              <div className='vip_card'>
                <NavLink to='/cardPage' className='noLink'>
                  <span className='card_favorite_icon'><img src={favorite} alt=""/></span>
                  <img src={`${STATIC_HOST}/${data?.previewImageAds[0]?.name}`} alt="" className='vip_card-img'/>
